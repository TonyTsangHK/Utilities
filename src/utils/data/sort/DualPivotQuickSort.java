...
public final class DualPivotQuickSort implements Sorter {
    ...
    private static <E> void sort(E[] a, Comparator<E> c, int left, int right, boolean leftmost) {
        ...
        if (c.compare(a[e2], a[e1]) < 0) { E t = a[e2]; a[e2] = a[e1]; a[e1] = t; }

        if (c.compare(a[e3], a[e2]) < 0) { E t = a[e3]; a[e3] = a[e2]; a[e2] = t;
            if (c.compare(t, a[e1])<0) { a[e2] = a[e1]; a[e1] = t; }
        }
        if (c.compare(a[e4], a[e3])<0) { E t = a[e4]; a[e4] = a[e3]; a[e3] = t;
            if (c.compare(t, a[e2])<0) { a[e3] = a[e2]; a[e2] = t;
                if (c.compare(t, a[e1])<0) { a[e2] = a[e1]; a[e1] = t; }
            }
        }
        if (c.compare(a[e5], a[e4])<0) { E t = a[e5]; a[e5] = a[e4]; a[e4] = t;
        ...
        if (c.compare(a[e1], a[e2]) != 0 && c.compare(a[e2], a[e3]) != 0 && c.compare(a[e3], a[e4]) != 0 && c.compare(a[e4], a[e5]) != 0) {
            ...
            sort(a, c, left, less - 2, leftmost);
            sort(a, c, great + 2, right, false);
             ...
             */
            sort(a, c,left, less - 1, leftmost);
            sort(a, c,great + 1, right, false);
        }
    }
